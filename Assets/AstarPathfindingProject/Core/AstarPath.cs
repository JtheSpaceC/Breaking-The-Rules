	...
	*/
	...
	bool ProcessGraphUpdates (bool force) {
		...
		while (graphUpdateQueueRegular.Count > 0) {
			...
			//UNDONE: GraphUpdateThreading threading = s.order == GraphUpdateOrder.FloodFill ? GraphUpdateThreading.SeparateThread : s.graph.CanUpdateAsync(s.obj);
			//HACK: I put in the following line as per this forum post from the designer http://forum.arongranberg.com/t/a-and-webgl/1424/3
